...
Junior Backend / Full-stack developer with experience building production full-stack applications. I specialize in TypeScript, NestJS, Next.js, and PostgreSQL. I can break tasks into milestones, write tests, configure CI/CD, and ship product features. I use AI tools professionally for task decomposition, code analysis, debugging, test generation, and documentation. I validate all work through lint, typecheck, tests, CI/CD, and production verification. I’m looking for a role in a product team where I can grow backend and full-stack skills.
...
- **Database / Infrastructure:** PostgreSQL, Prisma, Redis, Docker, Vercel, Render, Cloudflare
- **Testing / Quality:** Jest, Vitest, Testing Library, Supertest, Playwright
- **Tools:** Git, GitHub Actions, Swagger
...
- Implemented workspaces with OWNER/ADMIN/MEMBER RBAC, private channels that return 404 to non-members, standalone group chats with expiring invite links, contacts, and global search.
...
### NotGuilty Legal — commercial website for a law firm | 2026
...
- Deployed on Vercel behind Cloudflare for fast load times, HTTPS, and basic SEO.

### WagerPlay Backend — backend for a gaming platform | 2026
