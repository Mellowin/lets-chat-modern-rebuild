...
- Built secure file attachments with presigned uploads, authenticated proxy downloads, MIME-type validation, size limits, and Cyrillic filename support.
...
- Реалізував безпечні файлові вкладення: presigned-завантаження, завантаження через авторизований проксі, перевірку MIME-типу, ліміти розміру та підтримку кириличних імен файлів.
...
- Реализовал безопасные файловые вложения: presigned-загрузку, скачивание через авторизованный прокси, проверку MIME-типа, лимиты размера и поддержку кириллических имён файлов.
