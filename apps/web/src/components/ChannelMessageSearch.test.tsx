...
describe("ChannelMessageSearch", () => {
  ...
  it("calls getMessageContext and onLoadContext when jump returns false", async () => {
    ...
    const contextResult = {
      target: { id: "msg-1", channelId: "ch-1", content: "hello", parentId: null, replyToMessageId: null, replyTo: null, createdAt: "2024-01-01T00:00:00.000Z", updatedAt: "2024-01-01T00:00:00.000Z", editedAt: null, author: { id: "u1", username: "alice", displayName: null, avatarUrl: null }, reactions: [], attachments: [] },
      before: [],
      after: [],
      hasMoreBefore: false,
      hasMoreAfter: false,
