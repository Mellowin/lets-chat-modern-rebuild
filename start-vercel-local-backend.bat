...
echo ==========================================
echo Starting LetsChat Vercel + local backend...
echo ==========================================
...
echo.
echo Starting Vercel local backend script...
powershell -NoProfile -ExecutionPolicy Bypass -File ".\scripts\start-local-dev.ps1" -VercelBackend
